...
const format_date_interceptor_1 = require("../interceptors/format-date.interceptor");
const MODEL = 'payment';
...
let PaymentController = class PaymentController {
    ...
    updatePayments(paymentData) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.sharedService.processBulk(paymentData, MODEL, RESPONSE);
        });
    }
    deletePayment(id) {
        return __awaiter(this, void 0, void 0, function* () {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PaymentController.prototype, "updatePayments", null);
__decorate([
...
exports.PaymentController = PaymentController = __decorate([
    ...
    (0, common_1.UseInterceptors)(format_date_interceptor_1.FormatDateInterceptor),
